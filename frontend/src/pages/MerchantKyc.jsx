...
import { ArrowRight, FileText, Upload, Landmark, CheckCircle2, ChevronLeft, AlertCircle } from "lucide-react";
...
export default function MerchantKyc() {
  ...
  const validStep2 = () =>
    form.bank_account_number && form.bank_ifsc && form.account_holder_name && form.cancelled_cheque_b64;
