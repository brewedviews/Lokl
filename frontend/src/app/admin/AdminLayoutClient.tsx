...
/**
 * AdminLayoutClient. Inline login gate matches the legacy `/admin/login` →
 ...
 *
 * Split out of app/admin/layout.tsx (now a server component so it can
 * export real `metadata` + `robots: noindex` — a "use client" layout
 * segment can't). layout.tsx renders this unchanged, just wrapped.
 *
