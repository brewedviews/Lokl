      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-8">
          ...
          <div className="bg-white rounded-2xl p-6 border border-[#E5E2DC] h-fit sticky top-24">
            ...
            <button onClick={() => router.push("/checkout")} data-testid="checkout-btn" className="w-full mt-6 px-6 py-3.5 rounded-full bg-[#E68910] text-white font-semibold hover:bg-[#C9770E] transition">
              Checkout
            </button>
          </div>
        </div>
