      ...
      <div className="flex-1 w-full max-w-3xl mx-auto px-4 sm:px-8 py-10">
        ...
        <div className="space-y-8 text-[15px] leading-relaxed text-[#1C1C1C]">
          ...
          <section>
            ...
            <p className="text-[#595959]">Listing on Lokl is free, with zero commission on completed orders — merchants keep what they earn. Merchants are responsible for accurate product listings, stock availability and timely fulfilment. Merchants must not list counterfeit, prohibited or misleading products.</p>
          </section>
