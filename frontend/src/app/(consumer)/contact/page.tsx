  ...
  return (
    <div className="flex-1 flex flex-col bg-[#FDFBF7]">
      <div className="flex-1 w-full max-w-3xl mx-auto px-4 sm:px-8 py-10">
        ...
        <h1 className="text-2xl sm:text-3xl font-display font-bold text-[#0A1F5C] leading-tight mb-2">Contact Us</h1>
        ...
        <div className="space-y-8 text-[15px] leading-relaxed text-[#1C1C1C]">
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">Reach us</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">Support hours</h2>
            <p className="text-[#595959]">Our team is available 10:00 AM – 9:00 PM, every day. Messages sent outside these hours are answered the next morning.</p>
          </section>

          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">Order help</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">Want to sell on Lokl?</h2>
            <p className="text-[#595959]">
              Free to list, zero commission. WhatsApp us at the number above or head to{" "}
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">Where we are</h2>
