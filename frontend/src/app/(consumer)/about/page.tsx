  ...
  return (
    <div className="flex-1 flex flex-col bg-[#FDFBF7]">
      <div className="flex-1 w-full max-w-3xl mx-auto px-4 sm:px-8 py-10">
        ...
        <h1 className="text-2xl sm:text-3xl font-display font-bold text-[#0A1F5C] leading-tight mb-2">About Lokl</h1>
        ...
        <div className="space-y-8 text-[15px] leading-relaxed text-[#1C1C1C]">
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">Your neighbour&apos;s shop, not a faraway warehouse</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">Why local matters</h2>
            <p className="text-[#595959]">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">What we&apos;re building</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">Where we are today</h2>
            <p className="text-[#595959]">
