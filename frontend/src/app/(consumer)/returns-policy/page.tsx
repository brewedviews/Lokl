  ...
  return (
    <div className="flex-1 flex flex-col bg-[#FDFBF7]">
      <div className="flex-1 w-full max-w-3xl mx-auto px-4 sm:px-8 py-10">
        ...
        <h1 className="text-2xl sm:text-3xl font-display font-bold text-[#0A1F5C] leading-tight mb-2">Return &amp; Exchange Policy</h1>
        ...
        <div className="space-y-8 text-[15px] leading-relaxed text-[#1C1C1C]">
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">Try &amp; Buy — return on the spot</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">After the rider leaves</h2>
            <p className="text-[#595959]">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">Condition of items</h2>
            <p className="text-[#595959]">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">How refunds work</h2>
            <p className="text-[#595959]">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-[#0A1F5C] mb-3">Exchanges</h2>
            <p className="text-[#595959]">
